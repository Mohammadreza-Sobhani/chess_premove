...
void main() async {
  ...
  try {
    ...
    //
    // Because 'intelligence: true' is passed, the custom simulation algorithm checks all 29 possible
    // future moves for White in this specific turn.
    //
    // After analyzing the combinations, the engine determines that the Queen can NEVER
    // legally reach the following 3 squares in the very next turn, regardless of what White plays:
    // - b7
    // - f7
    // - d1
    //
    // Therefore, it strictly filters out those 3 impossible targets,
